...
Suite* coord_2d_suite(void)
{
    ...
    TCase* coord_2d_area_triangle = tcase_create("coord_2d_area_triangle");
    tcase_add_test(coord_2d_area_triangle, test_coord_2d_area_triangle);

    /* Add Cases to Suite */
    suite_add_tcase(s, tc_2d_eq);
    suite_add_tcase(s, tc_2d_dist);
    suite_add_tcase(s, tc_2d_midpoint);
    suite_add_tcase(s, coord_2d_area_triangle);
